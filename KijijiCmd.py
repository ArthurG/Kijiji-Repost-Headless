...
def main():
   ...
   showParser = subparser.add_parser('show', help='show currently listed ads')

   deleteParser = subparser.add_parser('delete', help='delete a listed ad')
   deleteParser.add_argument('id',type=str, help='id of the ad you wish to delete')

   repostParser = subparser.add_parser('repost', type=str help='repost an existing ad')
   repostParser = subparser.add_argument('inf_file', type = str, help = '.inf file containing posting details')
